sap.ui.define([
		...
		return BaseObject.extend("com.hilti.set.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias com.hilti.set.model.ListSelector
			 */
			 ...
			 * @return {com.hilti.set.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
