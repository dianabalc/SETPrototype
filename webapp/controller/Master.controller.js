/*global history */
sap.ui.define([
		"com/hilti/set/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"com/hilti/set/model/formatter",
		"com/hilti/set/model/grouper",
		...
		return BaseController.extend("com.hilti.set.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("Desc", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.hilti.set.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Number", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Number", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
