sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/hilti/set/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.hilti.set.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/hilti/set/localService/mockserver"], function (mockserver) {
